    ...
    return (
      ...
      <Container>
          ...
          <Nav className="me-auto">
            ...
            <NavLink className="mx-2 my-1" style={{ color: 'white', textDecoration: 'inherit' }} to="/terms">
    ...
    return (
      ...
      <Container>
          ...
          <Nav className="me-auto">
            ...
            <NavLink className="mx-2 my-1" style={{ color: 'white', textDecoration: 'underline', textUnderlineOffset: '4px' }} to="/terms">
              Terms and Conditions
            </NavLink>
          </Nav>
        <Nav>
