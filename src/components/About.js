...
<div className='content'>
              ...
              <p>A Pizza Inn pizza box might be one of the most recognisable icons of Africa. Whichever way you slice it, Pizza Inn is an industry leader in the quick service pizza game. The first Pizza Inn outlet opened its doors in 1994 in Harare, Zimbabwe, and rose quickly in popularity. Serving hot oven-fresh pizza with its signature all-natural tomato sauce and using only the freshest ingredients, 
                Pizza Inn has established itself at the top of the industry and is easily one of the first choices in quick service pizza in Africa.</p>

                <h3>Must be the Pizza!</h3>
                <p>Pizza Inn is known for its variety of pizza options, including its signature thin and crispy crust, 
                  as well as its extensive salad bar and dessert menu. In addition to pizza, 
                  the restaurant also serves calzones, pasta, sandwiches, and wings.</p>
                ...
                <div className='videos'>
                  ...
                  width="560" 
                  height="315" 
                  src="https://www.youtube.com/embed/kkKnMs2DyOE" 
                  title="Deluxe Thursdays -From pizza inn Kenya" 
                  frameborder="0" 
...
width="560"
 ...
 title="Pizza inn and Chicken inn , Mega Festive Feast." frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                   ...
                   width="560" 
                   height="315" 
                   src="https://www.youtube.com/embed/A5n37-S8gBk" title="Terrific Tuesdays Every Tuesday." frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                   allowfullscreen></iframe>
                </div>
            </div>
    </div>
